          ...
          --> */}
                        ...
                        <div className="flex-1 flex items-center justify-center md:items-stretch md:justify-start">
                            <div className="flex-shrink-0 flex items-center">
                                <img className="block md:hidden h-8 w-auto" src={logo} alt="Workflow" />
                                <img className="hidden md:block w-32" src={logo} alt="Workflow" />
                            </div>
                ...
                <div className={isOpen ? 'block absolute w-full bg-black' : 'hidden'} id="mobile-menu">
                    <div className="px-2 pt-2 pb-3 space-y-1">
                        {/* <!-- Current: "bg-gray-900 text-white", Default: "text-gray-300 hover:bg-gray-700 hover:text-white" --> */}
                        <NavLink to="/home" onClick={() => setIsOpen(!isOpen)} className="text-white block hover:bg-gray-900 px-3 py-2 rounded-md text-sm font-medium" aria-current="page">Home</NavLink>

                        <NavLink to="/about" onClick={() => setIsOpen(!isOpen)} className="text-gray-300 block hover:bg-gray-900 hover:text-white px-3 py-2 rounded-md text-sm font-medium">About</NavLink>

                        {user && <NavLink to="/myevents" onClick={() => setIsOpen(!isOpen)} className="text-gray-300 block hover:bg-gray-900 hover:text-white px-3 py-2 rounded-md text-sm font-medium">My Events</NavLink>}

                        {user && <NavLink to="/bookings" onClick={() => setIsOpen(!isOpen)} className="text-gray-300 block hover:bg-gray-900 hover:text-white px-3 py-2 rounded-md text-sm font-medium">Bookings</NavLink>}
                        {user && <NavLink to="/allevents" onClick={() => setIsOpen(!isOpen)} className="text-gray-300 block hover:bg-gray-900 hover:text-white px-3 py-2 rounded-md text-sm font-medium">All Events</NavLink>}
                        {user && <NavLink to="/addevents" onClick={() => setIsOpen(!isOpen)} className="text-gray-300 block hover:bg-gray-900 hover:text-white px-3 py-2 rounded-md text-sm font-medium">Add Events</NavLink>}
                    </div>
                </div>
            </nav>
